 ...
 * Explanation and Code from: Elements of Programming Interviews-Binary Tree; 9.3 Page 129
...
//LCA is the first node visited after the two nodes whose LCA we are to compute have been visited
public class LowestCommonAncestorInBinaryTree {
	...
	public static Status LCAHelper(BinaryTreeNode root, BinaryTreeNode node1, BinaryTreeNode node2) {
		...
		System.out.println("numTargetNodes: "+numTargetNodes);
...
//		tree.root.right.right = new BinaryTreeNode(8);
		...
		System.out.println(LCA(tree.root, tree.root.left.right, tree.root.left.left).data);		//LCA(5,6) -> 5
	}
